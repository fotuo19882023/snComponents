...
// 对象实例
const person1 = new Person('shenNong')
console.log(person1) // Person {name: 'shenNong'}
```
...
Person.prototype.name = 'shenNong'
...
console.log(person1.name, person2.name) // 'shenNong' 'shenNong'
```
...
// 对象实例
const person = new Person('shenNong')
