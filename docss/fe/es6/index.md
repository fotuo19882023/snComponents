...
```js
const [a, b, c] = 'shenNong'
console.log(a) // m
console.log(b) // a
console.log(c) // o

/* 解构 length 属性 */
const { length } = 'shenNong'
...
log('shenNong', 1, 2) // shenNong [1, 2]
log('shenNong', 1, 2, 3) // shenNong [1, 2, 3]
```
...
// 字符串会以字符数组的形式做合并
Object.assign({}, 'shenNong') // {0: 'm', 1: 'a', 2: 'o', 3: 'm', 4: 'a', 5: 'o'}
...
```js
const obj = { name: 'shenNong', age: 18 }
Object.keys(obj) // ['name', 'age']
Object.values(obj) //  ['shenNong', 18]
Object.entries(obj) // [['name', 'shenNong'], ['age', 18]]
```
...
```js
Object.fromEntries([['name', 'shenNong']]) // {name: 'shenNong'}

/* Map 转对象 */
const map = new Map([['name', 'shenNong']])
Object.fromEntries(map) // {name: 'shenNong'}

/* 将查询字符串转为对象 */
const params = 'name=shenNong&age=18'
Object.fromEntries(new URLSearchParams(params)) // {name: 'shenNong', age: '18'}
```
...
[Promise 实现](https://github.com/shenNong1996/Promise) 简易实现、A+ 规范实现、原型方法、静态方法实现
